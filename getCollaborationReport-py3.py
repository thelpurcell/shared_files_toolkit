...
sourceMembersToReportOn = 'users.csv'
...
with open( newFileName, 'wt') as csvfile:
	...
	writer.writerow(['Owner email', 'Owner Name','Folder Name', 'Folder Path', 'Folder ID', 'Mount Status', 'Collaborator Email', 'Collaborator Permissions', 
